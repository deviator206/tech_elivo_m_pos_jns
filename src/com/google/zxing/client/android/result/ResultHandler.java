...
/*
  ...
  private static final String[] PHONE_TYPE_STRINGS = {"home", "work", "mobile",
      "fax", "pager", "main"};
  ...
  ResultHandler(Activity activity, ParsedResult result, Result rawResult) {
    ...
    // Make sure the Shopper button is hidden by default. Without this, scanning
    // a product followed
  ...
  /*private static long calculateMilliseconds(String when) {
    if (when.length() == 8) {
      ...
      synchronized (DATE_TIME_FORMAT) {
        date = DATE_TIME_FORMAT.parse(when.substring(0, 15), new ParsePosition(
            0));
      }
  ...
  /*final void addPhoneOnlyContact(String[] phoneNumbers, String[] phoneTypes) {
    addContact(null, null, phoneNumbers, phoneTypes, null, null, null, null,
        null, null, null, null, null, null);
  }

  final void addEmailOnlyContact(String[] emails, String[] emailTypes) {
    addContact(null, null, null, null, emails, emailTypes, null, null, null,
        null, null, null, null, null);
  }*/

  /*final void addContact(String[] names, String pronunciation,
                        String[] phoneNumbers, String[] phoneTypes,
                        String[] emails, String[] emailTypes, String note,
                        String instantMessenger, String address,
                        String addressType, String org, String title,
    ...
    if (aggregatedNotes.length() > 0) {
      putExtra(intent, ContactsContract.Intents.Insert.NOTES, aggregatedNotes
          .toString());
    }
 ...
 /* final void shareByEmail(String contents) {
    sendEmailFromUri("mailto:", null, activity
...
*/
 /* final void sendMMS(String phoneNumber, String subject, String body) {
  ...
  final void sendMMSFromUri(String uri, String subject, String body) {
    Intent intent = new Intent(Intent.ACTION_SENDTO, Uri.parse(uri));
    // The Messaging app needs to see a valid subject or else it will treat this
    // an an SMS.
  ...
  *//**
  ...
  final void openProductSearch(String upc) {
    Uri uri = Uri.parse("http://www.google."
        + LocaleManager.getProductSearchCountryTLD(activity) + "/m/products?q="
        + upc + "&source=zxing");
  ...
  final void openBookSearch(String isbn) {
    Uri uri = Uri.parse("http://books.google."
        + LocaleManager.getBookSearchCountryTLD(activity) + "/books?vid=isbn"
        + isbn);
    launchIntent(new Intent(Intent.ACTION_VIEW, uri));
  }
