...
public final class Intents {
	 ...
	 * {@link android.content.Intent#putExtra(String, String)}, where format is
	 * one of {@link com.google.zxing.BarcodeFormat}.
	 */
	/*
	 * public static final String FORMAT = "ENCODE_FORMAT";
	 *//**
	 * Normally the contents of the barcode are displayed to the user in a
	 * TextView. Setting this boolean to false will hide that TextView, showing
	 * only the encode barcode.
	 */
	/*
	 ...
	 *//**
	 * Give the user a choice of items to encode as a barcode, then render it
	 * as a QR Code and display onscreen for a friend to scan with their phone.
	 */
	/*
	 * public static final String ACTION =
